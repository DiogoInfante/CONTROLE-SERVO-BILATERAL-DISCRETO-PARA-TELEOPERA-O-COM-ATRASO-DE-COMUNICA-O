...
%
% Trajetória: Estado Inicial até estado desejado. Não há controle com
% relação à trajetória em si.
%
% Manipulador Mestre: 
%
...
%% Estado Inicial
X0 = deg2rad([45 5 15 1]');

%% Estado Desejado
Xd = deg2rad([60 5 18 1]');
...
% Matriz de pesos Q1
Q1_s_expandido = [  10        0       0         0       0         0       0      0;
                    0         10^6    0         0       0         0       0      0;
                    0         0       10        0       0         0       0      0;
                    0         0       0         10^6    0         0       0      0;
                    0         0       0         0       10        0       0      0;
...
% Matriz de pesos Q2
Q2_s_expandido = [10^10 0; 0 10^10]; 
...
[U_m1, X_m1, Y_m1, Xest_m1, Erro_m1, U_s1, X_s1, Y_s1, Xest_s1, Erro_s1] = simuladorMestreEscravo1(modeloEspacoEstadoDiscreto, manipulador, X0, Xd, Lp_m, Lp_s, K_m, K_s, t);
Erro1 = X_m1 - X_s1;

%% Simulação 2 em Tempo Discreto com Mestre LQR e Escravo Kalman
[U_m2, X_m2, Y_m2, Xest_m2, Erro_m2, U_s2, X_s2, Y_s2, Xest_s2, Erro_s2] = simuladorMestreEscravo2(modeloEspacoEstadoDiscreto, manipulador, X0, Xd, Lp_m, K_m, K_s, t);
Erro2 = X_m2 - X_s2;

%% Simulação 3 em Tempo Discreto com Mestre LQR e Escravo Kalman com Atraso de 2T na Comuniação
[U_m3, X_m3, Y_m3, Xest_m3, Erro_m3, U_s3, X_s3, Y_s3, Xest_s3, Erro_s3] = simuladorMestreEscravo3(modeloEspacoEstadoDiscreto, modeloEspacoEstadoDiscretoExpandido, manipulador, X0, Xd, Lp_m, K_m, K_s_expandido, t);
Erro3 = X_m3 - X_s3(:,1:4);

%% Simulação 4 em Tempo Discreto com Mestre LQR e Escravo Kalman com Atraso de 2T e Ruído na Comuniação
[U_m4, X_m4, Y_m4, Xest_m4, Erro_m4, U_s4, X_s4, Y_s4, Xest_s4, Erro_s4] = simuladorMestreEscravo4(modeloEspacoEstadoDiscreto, modeloEspacoEstadoDiscretoExpandidoRuido, manipulador, manipulador_ruido, X0, Xd, Lp_m, K_m, K_s_expandido, t);
Erro4 = X_m4 - X_s4(:,1:4);
...
[U_m5, X_m5, Y_m5, Xest_m5, Erro_m5, U_s5, X_s5, Y_s5, Xest_s5, Erro_s5] = simuladorMestreEscravo5(modeloEspacoEstadoDiscretoQnt, modeloEspacoEstadoDiscretoExpandidoRuidoQntPert, manipulador_qnt, manipulador_ruido_qnt_pert, X0, Xd, Lp_m, K_m, K_s_expandido, t);
Erro5 = X_m5 - X_s5(:,1:4);
