function [U_m, X_m, Y_m, Xest_m, Erro_m, U_s, X_s, Y_s, Xest_s, Erro_s] = simuladorMestreEscravo4(modeloEspacoEstadoDiscreto_m, modeloEspacoEstadoDiscreto_s, manipulador_m, manipulador_s, X0, Xd, Lp_m, K_m, K_s, t)
...
for t0 = t
   ...
   Xd_s = [Y_m(1)+vstd1_s*randn(1); 0; Y_m(2)+vstd2_s*randn(1); 0; 0; 0; 0; 0];  % Escravo conhece os sensores de posição do mestre
