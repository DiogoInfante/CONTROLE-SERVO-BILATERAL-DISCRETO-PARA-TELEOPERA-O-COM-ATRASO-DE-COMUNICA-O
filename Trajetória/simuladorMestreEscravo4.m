function [U_m, X_m, Y_m, Xest_m, Erro_m, U_s, X_s, Y_s, Xest_s, Erro_s] = simuladorMestreEscravo4(modeloEspacoEstadoDiscreto_m, modeloEspacoEstadoDiscreto_s, manipulador, trajetoria, Lp_m, K_m, K_s, t)
...
for t0 = t
   ...
   % Estados desejados
   Xd_m = cinematicaInversa(xd(k+1), xdp(k+1), yd(k+1), ydp(k+1), manipulador);  % Mestre conhece os estados desejados
