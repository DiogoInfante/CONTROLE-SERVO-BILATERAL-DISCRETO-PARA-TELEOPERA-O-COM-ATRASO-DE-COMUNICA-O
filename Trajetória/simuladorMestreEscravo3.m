function [U_m, X_m, Y_m, Xest_m, Erro_m, U_s, X_s, Y_s, Xest_s, Erro_s] = simuladorMestreEscravo3(modeloEspacoEstadoDiscreto_m, modeloEspacoEstadoDiscreto_s, manipulador, trajetoria, Lp_m, K_m, K_s, t)
