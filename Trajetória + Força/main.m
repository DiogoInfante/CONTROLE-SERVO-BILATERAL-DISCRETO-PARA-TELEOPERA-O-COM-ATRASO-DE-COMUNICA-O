...
formato = 'retaVertical';          % Formatos disponívies: 'circulo', 'retaVertical
...
f_ext1 = [0; 0];
[Xd_m1, U_m1, X_m1, Y_m1, Xest_m1, Erro_m1, U_s1, X_s1, Y_s1, Xest_s1, Erro_s1] = simuladorMestreEscravo(modeloEspacoEstadoDiscreto, manipulador, trajetoria, f_ext1, Lp_m, Lp_s, K_m, K_s, t);
Erro1 = X_m1 - X_s1;
Erro1d = Xd_m1 - X_s1;

%% Simulação 2 em Tempo Discreto com Mestre LQR e Escravo Kalman
f_ext2 = [0; 20];
[Xd_m2, U_m2, X_m2, Y_m2, Xest_m2, Erro_m2, U_s2, X_s2, Y_s2, Xest_s2, Erro_s2] = simuladorMestreEscravo(modeloEspacoEstadoDiscreto, manipulador, trajetoria, f_ext2, Lp_m, Lp_s, K_m, K_s, t);
Erro2 = X_m2 - X_s2;
Erro2d = Xd_m2 - X_s2;

%% Display & Plots

% Evolução dos Estados ao Longo do Tempo do Mestre e Escravos:
plotEstado(X_m1, X_s1, f_ext1, 1, t)
plotEstado(X_m1, X_s1, f_ext1, 2, t)
plotEstado(X_m1, X_s1, f_ext1, 3, t)
plotEstado(X_m1, X_s1, f_ext1, 4, t)

plotEstado(X_m2, X_s2, f_ext2, 1, t)
plotEstado(X_m2, X_s2, f_ext2, 2, t)
plotEstado(X_m2, X_s2, f_ext2, 3, t)
plotEstado(X_m2, X_s2, f_ext2, 4, t)
% 
% Evolução das Atuações ao Lngo do Rempo do Mestre e Escravo:
plotAtuacao(U_m1, U_s1, f_ext1, 1, t)
plotAtuacao(U_m2, U_s2, f_ext2, 1, t)
plotAtuacao(U_m1, U_s1, f_ext1, 2, t)
plotAtuacao(U_m2, U_s2, f_ext2, 2, t)
...
plotTrajeto(Xd_m1, Y_m1, Y_s1, f_ext1, manipulador, t)
plotTrajeto(Xd_m2, Y_m2, Y_s2, f_ext2, manipulador, t)
%
...
displayRMSD(Erro1, 1)
displayRMSD(Erro1d, 2)

%displayRMSD(Erro2, 2)


%displayRMSD(Erro2d, 2)
